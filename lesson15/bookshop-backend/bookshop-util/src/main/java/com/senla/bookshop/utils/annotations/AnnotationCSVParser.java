...
public class AnnotationCSVParser {
	...
	public static String parseToString(Object object, String keyField)
	...
	public static Object parseToObject(Class<?> entity, String[] cutLine) throws InstantiationException,
