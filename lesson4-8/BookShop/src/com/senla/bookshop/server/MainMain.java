...
public class MainMain {
	...
	//	AnnotationCSVReader.readerFromCsv(Order.class);
	//	OrderStorage.getInstance().setOrderBooks((List<Order>) AnnotationCSVReader.readerFromCsv(Order.class));
	//	AnnotationCSVReader.readCSV(Book.class);
	//	for(Object temp : AnnotationCSVReader.readerFromCsv(Book.class))
	...
	public void booklist(){
		...
		BookStorage.getInstance().addBook(new Book(123, "Fairy tales",  2250.0, 1868 , true));
	}
